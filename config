...
try:
    ...
    config_module_location = os.path.join(location, "data", "default_config")
    user_config_location = os.path.join(location, "config")
    
    config_mgmt.emergency_config_reset(default_config_location, config_module_location, user_config_location)
